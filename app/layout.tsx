...
export default function RootLayout({
  ...
  return (
    <html>
      <head>
        <meta charSet="UTF-8" />
        <title>AllShop - best stuff for almost best prices.</title>
        <link
      ...
      <body className="antialiased">
        <div className="container mx-auto grid grid-cols-8 gap-4 min-h-100vh px-3 md:px-0">
          <div className="hidden xl:block col-start-1 col-span-1 relative">
            <a className="absolute inset-0 py-16 px-4" href="/banner">
          ...
          <div className="hidden xl:block col-span-1 col-start-8 relative">
            <a className="absolute inset-0 py-16 px-4" href="/banner">
